...
os.environ["WANDB_PROJECT"] = "llama3-medium-WikiText103"  # name your W&B project
...
class ModelArguments:
    ...
    hf_token: str = field(
        ...
        metadata={
            "help": (
                "Used for login into the Hugging Face Hub."
            )
        },
    )
...
def main():
    ...
    if model_args.hf_token is not None:
        login(token=model_args.hf_token, add_to_git_credential=True)
    ...
    if model_args.model_name_or_path:
        ...
        #         nn.init.normal_(modules.weight, mean=0.0, std=std)
