...
from ghn3.llama_1k import Llama_1KDDP
from ghn3.nn import GHN3_GPT
from ghn3.utils import log
from ghn3.trainer_llama import Trainer
...
def main():
    ...
    raw_datasets = load_dataset(args.dataset,args.dataset_config_name, cache_dir=args.data_dir)
    ...
    if args.block_size is None:
        ...
        print(tokenizer.model_max_length, config.max_position_embeddings)
    ...
    graphs_queue, sampler = Llama_1KDDP.loader(
